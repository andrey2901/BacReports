...
public class OutcomingsPrinter
{
   private static final Logger logger = Logger.getLogger(OutcomingsPrinter.class);
   ...
   public void print(JTable table, String dateFrom, String dateTo)
   {
      try
      {
         ...
         PdfWriter.getInstance(document, new FileOutputStream(
               System.getProperty("report.folder") + "/Spysannia_" + dateFrom + "_" + dateTo + ".pdf"));
      ...
      {
         logger.error("Spysannia_" + dateFrom + "_" + dateTo + ".pdf wasn't printed.", e);
      }
   }
}