...
public class RemainsPatronReportPrinter
{
   private static final Logger logger = Logger.getLogger(RemainsPatronReportPrinter.class);
   ...
   public void print(JTable table, String date)
   {
      try
      {
         ...
         PdfWriter.getInstance(document,
               new FileOutputStream(System.getProperty("report.folder") + "/Zalyshky_mecenat_na_" + date + ".pdf"));
