...
public class IncomingsPrinter
{
   private static final Logger logger = Logger.getLogger(IncomingsPrinter.class);
   ...
   public void print(JTable table, String dateFrom, String dateTo)
   {
      try
      {
         ...
         PdfWriter.getInstance(document, new FileOutputStream(
               System.getProperty("report.folder") + "/Nadhodzhennia_" + dateFrom + "_" + dateTo + ".pdf"));
      ...
      {
         logger.error("Nadhodzhennia_" + dateFrom + "_" + dateTo + ".pdf wasn't printed.", e);
      }
   }
}
