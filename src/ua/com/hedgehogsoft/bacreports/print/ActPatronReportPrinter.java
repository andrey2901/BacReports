...
public class ActPatronReportPrinter
{
   private static final Logger logger = Logger.getLogger(ActPatronReportPrinter.class);
   ...
   public void print(JTable table, String dateFrom, String dateTo)
   {
      try
      {
         ...
         PdfWriter.getInstance(document, new FileOutputStream(
               System.getProperty("report.folder") + "/Act_spysannia_mecenat_" + dateFrom + "_" + dateTo + ".pdf"));
